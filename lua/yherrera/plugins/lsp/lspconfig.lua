return {
  ...
  config = function()
    ...
    -- Change the Diagnostic smbols in the sign column (gutter)
    ...
    mason_lspconfig.setup_handlers({
      ...
      function(server_name)
        lspconfig[server_name].setup({
          capabilities = capabilities, -- This is for autocompletion
        })
      end,
      -- You can configure your own language in the way you want, use the next configurations as examples
      ["svelte"] = function()
      ...
      ["emmet_ls"] = function()
        ...
        lspconfig["emmet_ls"].setup({
          capabilities = capabilities,
          filetypes = { "html", "typescriptreact", "javascriptreact", "css", "sass", "scss", "less", "svelte", "java" },
        })
      end,
